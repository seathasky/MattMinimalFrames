MMF_Config = {
    ...
    FRAME_DEFINITIONS = {
        ...
        { unit = "pet",          name = "MMF_PetFrame",            width = 100, height = 28, x = -340, y = -100, label = "Pet Frame" },
        { unit = "focus",        name = "MMF_FocusFrame",          width = 100, height = 28, x = 340,  y = -100, label = "Focus Frame" },
