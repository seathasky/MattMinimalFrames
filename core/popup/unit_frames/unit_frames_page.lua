local function MMF_SetupUnitFramesHeader(unitFramesCol, accentColor, createSubTabBar, requestScrollRefresh)
    ...
    local sectionDefs = {
        ...
        { label = "Offsets", subtitle = "Adjust text positions for each supported unit.", x = 0, y = 544, width = 288, height = 390, guide = "Use this page to move text positions.\nGreat for fine-tuning alignment after sizing and text changes." },
        ...
        { label = "OOC", subtitle = "Out-of-combat visibility and fade rules.", x = 300, y = 258, width = 288, height = 236, guide = "Use this page to control how frames look out of combat.\nYou can fade frames when they are less important." },
        { label = "Appearance", subtitle = "Textures, fonts, and frame colors.", x = 588, y = 6, width = 316, height = 684, guide = "Use this page to style your frames.\nChange textures, fonts, and colors to match your UI." },
